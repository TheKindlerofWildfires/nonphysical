...
mod fourier_heap {
    ...
    use nonphysical_core::{shared::{complex::{Complex, ComplexScaler}, float::Float}, signal::fourier::{heap::ComplexFourierTransformHeap, FourierTransform}};
...
mod fourier_stack {
    ...
    use nonphysical_core::{shared::{complex::{Complex, ComplexScaler}, float::Float, primitive::Primitive}, signal::fourier::{stack::ComplexFourierTransformStack, FourierTransform}};
    use nonphysical_std::shared::primitive::F32;
    ...
    fn forward_2_static() {
        let mut x = (0..2)
            .map(|i| ComplexScaler::<F32>::new(F32(i as f32), F32((i+1) as f32)))
            .collect::<Vec<_>>();
        let fft = ComplexFourierTransformStack::<ComplexScaler<F32>,1>::new(x.len());
    ...
    fn forward_4_static() {
        let mut x = (0..4)
            .map(|i| ComplexScaler::<F32>::new(F32(i as f32), F32((i+1) as f32)))
            .collect::<Vec<_>>();
        let fft = ComplexFourierTransformStack::<ComplexScaler<F32>,2>::new(x.len());
    ...
    fn forward_8_static() {
        let mut x = (0..8)
            .map(|i| ComplexScaler::<F32>::new(F32(i as f32), F32((i+1) as f32)))
            .collect::<Vec<_>>();
        let fft = ComplexFourierTransformStack::<ComplexScaler<F32>,4>::new(x.len());
    ...
    fn forward_16_static() {
        let mut x = (0..16)
            .map(|i| ComplexScaler::<F32>::new(F32(i as f32), F32((i+1) as f32)))
            .collect::<Vec<_>>();
        let fft = ComplexFourierTransformStack::<ComplexScaler<F32>,8>::new(x.len());
        ...
        let truth_1 = [
            ...
            ComplexScaler::<F32>::new(F32(-13.3454291), F32(-2.6545709)),
            ComplexScaler::<F32>::new(F32(-11.3137085), F32(-4.6862915)),
            ComplexScaler::<F32>::new(F32(-9.5912989), F32(-6.40870106)),
            ComplexScaler::<F32>::new(F32(-8.0), F32(-8.0)),
            ComplexScaler::<F32>::new(F32(-6.40870106), F32(-9.59129894)),
            ComplexScaler::<F32>::new(F32(-4.6862915), F32(-11.3137085)),
            ComplexScaler::<F32>::new(F32(-2.6545709), F32(-13.3454291)),
    ...
    fn reverse() {
        let mut x = (0..1024)
            .map(|i| ComplexScaler::<F32>::new(F32(i as f32), F32((i+1) as f32)))
            .collect::<Vec<_>>();
        let fft: ComplexFourierTransformStack<ComplexScaler<F32>,512> = ComplexFourierTransformStack::new(x.len());
        fft.fft(&mut x);
        fft.ifft(&mut x);
        (0..1024).zip(x.iter()).for_each(|(i,xp)|{
            assert!((F32(i as f32)-xp.real).l2_norm() < F32::EPSILON);
    ...
    fn time_2048(){
        ...
        let mut x = (0..2048)
            .map(|i| ComplexScaler::<F32>::new(F32(i as f32), F32((i+1) as f32)))
            .collect::<Vec<_>>();
        let fft: ComplexFourierTransformStack<ComplexScaler<F32>,1024> = ComplexFourierTransformStack::new(x.len());
        (0..1024).for_each(|_|{
            fft.fft(&mut x);
        });
        let forward_time = forward.elapsed();
    ...
    fn time_4096(){
        ...
        let mut x = (0..4096)
            .map(|i| ComplexScaler::<F32>::new(F32(i as f32), F32((i+1) as f32)))
            .collect::<Vec<_>>();
        let fft: ComplexFourierTransformStack<ComplexScaler<F32>,2048> = ComplexFourierTransformStack::new(x.len());
        (0..1024).for_each(|_|{
            fft.fft(&mut x);
        });
        let forward_time = forward.elapsed();
