...
pub struct DeviationLayerTotal {
    name: String,
    include_mean: bool,
}

impl<F: Float> Layer<F> for DeviationLayerTotal {
    ...
    fn backward_ref(&self, _gradient: &mut Self::Matrix, _memory: &Self::Matrix) {
        todo!()
    }
}

pub struct DeviationLayerAxis {
    name: String,
    axis: usize,
}

impl<F: Float> Layer<F> for DeviationLayerAxis {
    type Matrix = MatrixHeap<F>;
